...
func save_cropped_screenshot_and_animate():
	...
	llmOutputLabel.text += "\n\n[Jay Petey]: "
	LlmServer.send_to_llm_server(Global.SYSTEM, "Look closely at the index finger tip position on the world map and determine which country it is close too.", false, Global.SCREENSHOT_URL, Global.SYSTEM_IMAGE_URL)
